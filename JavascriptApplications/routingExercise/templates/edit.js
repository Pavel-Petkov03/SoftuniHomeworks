...
import { generateRequest, getUserInfo, retrieveData } from "../utils.js"
        ...
        <form>
            <div class="row space-top">
                ...
                <div class="col-md-4">
                    ...
                    <input type="submit" class="btn btn-info" value="Edit" @click=${edit} id="${data._id}"/>
                </div>
            </div>
        </form>
` 
...
async function edit(ev){
    ...
    console.log(data);
    try{
        await generateRequest(`http://localhost:3030/data/catalog/${id}` , "put", data, getUserInfo().accessToken)
...
export function renderEditPage(ctx){
    const data = retrieveData(document.querySelector("form"))
    Object.assign(data , {_id : ctx.params.id})
