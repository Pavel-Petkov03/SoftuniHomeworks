...
# noEquipment
# yes
# 6	The price is 456.00lv! Have a nice time!	Градът е Боровец, а пакетът е без екипировка, съответно цената за ден е 80лв. Клиентът разполага с VIP пакет, така че цената за ден става 80-80*0.05=76лв.Резервацията е за 6 дни, следователно крайната цена е 76*6=456лв.
# Bansko
# withEquipment
# no
# 2	The price is 200.00lv! Have a nice time!
city = input()
package = input()
vip_discount = input()
days = int(input())
