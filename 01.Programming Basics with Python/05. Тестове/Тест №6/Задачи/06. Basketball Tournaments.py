...
# имена на турнири до получаване на команда "End of tournaments". За всеки турнир ще получавате цяло число,
# което ще показва броя на мачовете, които се играят за турнир. За всеки мач ще получавате: на първия ред точките,
# които е вкарал отборът на Деси, а на втория ред - точките, които е вкарал противниковият отбор.
...
# са повече от точките на противниковия отбор): "Game {кой е номерът на мача, който са изиграли за текущия турнир}
# of tournament {име на турнира}: win with {разликата между точките на отбора на Деси и противниковия отбор} points."
...
while command != "End of tournaments":
    ...
    for b in range(1 , matches + 1):
        ...
        if Desi_team > other_team:
            win += 1
            print(f"Game {b} of tournament {command}: win with {abs(Desi_team - other_team)} points.")
        else:
            lose += 1
            print(f"Game {b} of tournament {command}: lost with {abs(Desi_team - other_team)} points.")
    command = input()
print(f'{(win / all_matches * 100):.2f}% matches win')
print(f'{(lose / all_matches * 100):.2f}% matches lost')
